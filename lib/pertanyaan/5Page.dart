...
import 'package:project_sistemcerdas/pertanyaan/6Page.dart';
...
class fivePage extends StatefulWidget {
  ...
  fivePage({required this.rendahg, required this.rendahs, required this.sedangs, required this.tinggis, required this.nama, required this.email});
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text(
                            '1. Apakah anda merasa gelisah jika tidak bermain game ?',
                            style: TextStyle(
                              color: Colors.blue,
                              fontSize: 16,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          // kiri, atas, kanan, bawah
                          child: Text(
                            '2. Apakah Anda suka menyendiri di suatu tempat ?',
                            style: TextStyle(
                              color: Colors.blue,
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          // kiri, atas, kanan, bawah
                          child: Text(
                            '3. Apakah jika anda diajak berbicara, topik yang anda bicarakan selalu tentang game ?',
                            style: TextStyle(
                              color: Colors.blue,
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          // kiri, atas, kanan, bawah
                          child: Text(
                            '4. Apakah Anda menganggap game sebagai teman terbaik ?',
                            style: TextStyle(
                              color: Colors.blue,
                              fontSize: 16,
                              fontWeight: FontWeight.bold,
          ...
          child: Row(
            ...
            children: <Widget>[
              ...
              Padding(
                ...
                child: ElevatedButton(
                  onPressed: () {
                    double sedangg = calculateResult(
                      a1, b1, c1,
                      a2, b2, c2,
                      a3, b3, c3,
                      a4, b4, c4,
                    );
                    String sedanggString = sedangg.toString();

                    Navigator.push(
                      context,
                      MaterialPageRoute(
                        builder: (context) => sixPage(
                          sedangg: sedanggString,
